  ...
  flightStock: FlightStock[] = [
    {
      ...
      stock: [
        ...
        { name: "Coke", quantity: 40, epc: "sgvadfbdfab" },
    { name: "Pepsi", quantity: 30, epc: "ffbadfbfdb" },
    { name: "Sprite", quantity: 25, epc: "afsgbdfgab" },
    { name: "Fanta", quantity: 35, epc: "fsbadfbdfb" },
    { name: "Mountain Dew", quantity: 20, epc: "dsgavbdfbs" },
    { name: "Dr Pepper", quantity: 28, epc: "abdfbfdbga" },
    { name: "7UP", quantity: 18, epc: "fdgabadfbf" },
    { name: "Gatorade", quantity: 22, epc: "sfbdfbdfga" },
    { name: "Red Bull", quantity: 15, epc: "dfvbdafbdfb" },
    { name: "Monster", quantity: 19, epc: "sfbdfbagfd" },
    { name: "Powerade", quantity: 27, epc: "gbdfbdfgas" },
    { name: "Arizona", quantity: 32, epc: "sfbafdbdfb" },
    { name: "Snapple", quantity: 29, epc: "dfbdfbgsdf" },
    { name: "Lipton", quantity: 34, epc: "dfgasdfbdfb" },
    { name: "Tropicana", quantity: 26, epc: "fsbdafgbdfb" },
    { name: "Minute Maid", quantity: 21, epc: "sgbdfbadfb" },
    { name: "Nesquik", quantity: 17, epc: "fsbdfbsgbd" },
    { name: "Starbucks", quantity: 24, epc: "dfgasdfbdfg" },
    { name: "Vitaminwater", quantity: 20, epc: "sfbdfbafsb" },
    { name: "Nestea", quantity: 33, epc: "dfbadfbdfb" },
    { name: "Aquafina", quantity: 38, epc: "fbadfbsgfb" },
    { name: "Dasani", quantity: 36, epc: "sdfbdfbsdf" },
    { name: "Poland Spring", quantity: 31, epc: "fsbdfbdfbs" },
    { name: "Evian", quantity: 23, epc: "gbdfbdfbga" },
    { name: "Fiji", quantity: 37, epc: "sgbdfbadfb" },
    { name: "Smartwater", quantity: 39, epc: "dfbdfgasdf" },
    { name: "Voss", quantity: 30, epc: "sfbdfbadfb" },
    { name: "Perrier", quantity: 28, epc: "dfgbdfbdfb" },
    { name: "San Pellegrino", quantity: 35, epc: "sfbdfbsgfd" },
    { name: "LaCroix", quantity: 25, epc: "dfbdfbdfbs" }
